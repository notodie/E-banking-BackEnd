...
import ma.emsi.ebankingbackend.mappers.BankAccountMapperImp;
...
public class BankAccountServiceImpl implements BankAccountService {
    ...
    public SavingBankAccountDTO saveSavingBankAccount(double initialBalance, double interestRate, Long customerId) throws CustomerNotFoundException {
       ...
       SavingAccount savingAccount=new SavingAccount();
        ...
        savingAccount.setIntersRate(interestRate);
    ...
    public void debit(String accountId, double amount, String description) throws BankAccountNotFoundExeption, BalanceNotSufficientException {
        ...
        AccountOperation accountOperation=new AccountOperation(); accountOperation.setType(OperationType.DEBIT);
